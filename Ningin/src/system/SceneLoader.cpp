	...
	switch (id)
	{
		...
		case 1: {
			...
			for (uint32_t propertyPointer : propertiesPointers)
			{
				...
				{
					tintingColor = Color(ReadU8(&currentPointer), ReadU8(&currentPointer),
						ReadU8(&currentPointer), ReadU8(&currentPointer));
				}
		...
		case 2: {
			...
			for (uint32_t propertyPointer : propertiesPointers)
			{
				...
				{
					textColor = Color(ReadU8(&currentPointer), ReadU8(&currentPointer),
						ReadU8(&currentPointer), ReadU8(&currentPointer));
				}
				else if (name == "Text")
				{
