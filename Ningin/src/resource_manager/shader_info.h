...
/**
    ...
    Fields:
    - `paths`: An `unordered_map` mapping shader type identifiers ("vertex" and "fragment") to their respective file
   paths.
...
class ShaderInfo
{
  public:
    ...
    */
    ShaderInfo(const std::filesystem::path &vertex_path, const std::filesystem::path &fragment_path,
