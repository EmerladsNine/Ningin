...
/**
 * A class providing a wide collection of pre-defined colors that can be used.
 * Each color is represented by the `Color` class and initialized with specific RGBA values.
 */
class Colors
{
public:
	 ...
	 * @return A `Color` instance with the given RGBA values.
	 */
